 ...
 * @author Dongguabai
 * @Description
 * @Date 创建于 2020-12-19 15:33
 */
@Configuration
// 精确到 mapper 目录，以便跟其他数据源隔离
@MapperScan(basePackages = "com.dongguabai.distributedtransaction.atomikos.persistence.mapper.mapper2", sqlSessionFactoryRef = "sqlSessionFactory2")
